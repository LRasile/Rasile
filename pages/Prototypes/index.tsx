    ...
    <div>
      ...
      <div className="row justify-content-center p-4">
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/JungleClears')} style={{ cursor: 'pointer', textAlign: 'center' }}>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/PokemonEffectiveness')} style={{ cursor: 'pointer', textAlign: 'center' }}>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/LoopHeroSolver')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>🔁</span>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/CardsForBeats')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>🥁</span>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/Menu')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>🍝</span>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/Timezones')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>⏰</span>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/HtmlColors')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>🎨</span>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/ContractionTimer')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>👶</span>
        ...
        <div className="col-lg-3 col-md-6 my-2">
          <div className="card" onClick={() => router.push('Prototypes/PhpMigration')} style={{ cursor: 'pointer', textAlign: 'center' }}>
            <span style={{ margin: 'auto', paddingTop: 10, fontSize: 100 }}>🐘</span>
